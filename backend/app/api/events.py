...
async def get_events(db: AsyncSession = Depends(get_db)):
    ...
    for ev in events:
        ...
        events_data.append({
            ...
            "artist_popularity": ev.artist.popularity if ev.artist else None,
            "artist_followers": ev.artist.followers if ev.artist else None,
            "artist_genres": ev.artist.genres if ev.artist else [],
